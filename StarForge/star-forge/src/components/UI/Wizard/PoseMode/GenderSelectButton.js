...
function GenderSelectButton(props) {
  ...
  function handleChange1(event) {
    ...
    props.setGender(1, event.target.value);
  }

  function handleChange2(event) {
      setValue2(event.target.value);
      props.setGender(2, event.target.value);
  }
...
export default withStyles(styles)(GenderSelectButton);