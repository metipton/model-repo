...
exports.createStripeCustomer = functions.database.ref('/users/{userid}').onCreate((snapshot, context) => {
  ...
  return stripe.customers.create({
    ...
    return admin.database().ref(`/stripe_customers/${uid}/customer_id`).set(customer.id);
  });
});
